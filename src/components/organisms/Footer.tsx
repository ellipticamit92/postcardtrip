...
export function Footer() {
  return (
    <footer className="w-full bg-background border-t border-border mt-16">
      ...
      <div className="container mx-auto px-4 py-6 text-center bg-primary text-primary-foreground">
        <h2 className="text-lg font-semibold mb-2">Ready for your next adventure?</h2>
      ...
      <div className="container mx-auto px-4 py-4 text-xs text-muted-foreground text-center border-t border-border">
        &copy; {new Date().getFullYear()} PostcardTrip. All rights reserved. | <a href="#" className="hover:underline">Privacy Policy</a> | <a href="#" className="hover:underline">Terms of Service</a>
      </div>
    </footer>
  );
} 