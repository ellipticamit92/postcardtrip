    ...
    <a href={link} className="px-1 w-4/5 xs:w-1/2 sm:w-1/3 lg:w-1/4 xl:flex-1 mb-4 md:px-2">
      <div className="relative z-10 w-full h-72 xs:h-80 group">
        ...
        <div className="absolute z-20 inset-0 flex flex-col justify-end text-center text-white pb-10">
          <div className="relative after:absolute after:left-1/2 after:transition-all after:ease-in after:delay-300 after:-translate-x-1/2 after:w-10 after:h-1 after:bg-white after:rounded-md group-hover:after:bg-primary-400 md:after:w-8">
            ...
            <Paragraph className="scale-0 transition-all ease-in duration-300 delay-300 mt-2 mb-3 group-hover:scale-100 group-hover:text-primary-400">
              {packages} packages
            </Paragraph>
          </div>
        </div>
