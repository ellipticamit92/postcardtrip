...
export const getAllInclusions = async () => {
  const res = await fetch(`${CMS_BASE_URL}/inclusions`, {
    headers: {
      "x-api-key": API_KEY,
    },
    cache: "no-store",
...
export const getInclusionById = async (id: string) => {
  const res = await fetch(`${CMS_BASE_URL}/inclusions/${id}`, {
    headers: {
      "x-api-key": API_KEY,
    },
    cache: "no-store",
...
export const getPopularInclusions = async () => {
  const res = await fetch(`${CMS_BASE_URL}/inclusions/popular`, {
    headers: {
      "x-api-key": API_KEY,
    },
    cache: "no-store",
